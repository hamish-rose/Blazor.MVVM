...
using Blazor.MVVM.Lib.Components;
...
namespace Blazor.MVVM.ExampleComponents.Components.Tables {
    ...
    public class VirtualPagedTable<TItem> : ComponentWithViewModel<VirtualPagedTableViewModel<TItem>> {
        ...
        /// </summary>
        /// <param name="pageRequest"> request for items</param>
        public delegate Task<PageResponse<TItem>> ItemsProviderDelegate(PageRequest pageRequest);
